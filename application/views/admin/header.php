...
<script type="text/javascript" src="<?=base_url();?>admin/js/custom/dashboard.js"></script>
<!--[if lt IE 9]>
...
<body class="loggedin">
	...
	<div class="header radius3">
    	<div class="headerinner">
            ...
            <a href="<?=base_url();?>admin/#"><img src="<?=base_url();?>admin/images/starlight_admin_template_logo_small.png" alt="" /></a>
